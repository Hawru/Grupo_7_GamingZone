...
function initModels(sequelize) {
  ...
  product_plataform.belongsTo(plataforms, {
    as: "plataform_type",
    foreignKey: "plataform_type_id"
  });

  plataforms.hasMany(product_plataform, {
    as: "product_plataforms",
    foreignKey: "plataform_type_id"
  });

  product_comments.belongsTo(products, {
    as: "product",
    foreignKey: "product_id"
  });

  products.hasMany(product_comments, {
    as: "product_comments",
    foreignKey: "product_id"
  });
  ...
  product_plataform.belongsTo(products, {
    as: "product",
    foreignKey: "product_id"
  });

  products.hasMany(product_plataform, {
    as: "product_plataforms",
    foreignKey: "product_id"
  });

  product_requirement.belongsTo(products, {
    as: "product",
    foreignKey: "product_id"
  });

  products.hasMany(product_requirement, {
    as: "product_requirements",
    foreignKey: "product_id"
  });

  product_score.belongsTo(products, {
    as: "product",
    foreignKey: "product_id"
  });

  products.hasMany(product_score, {
    as: "product_scores",
    foreignKey: "product_id"
  });
  ...
  product_requirement.belongsTo(requirement_types, {
    as: "requirement",
    foreignKey: "requirement_id"
  });

  requirement_types.hasMany(product_requirement, {
    as: "product_requirements",
    foreignKey: "requirement_id"
  });

  invoice_details.belongsTo(sales, {
    as: "sale",
    foreignKey: "sale_id"
  });

  sales.hasMany(invoice_details, {
    as: "invoice_details",
    foreignKey: "sale_id"
  });

  product_score.belongsTo(score_types, {
    as: "score_type",
    foreignKey: "score_type_id"
  });

  score_types.hasMany(product_score, {
    as: "product_scores",
    foreignKey: "score_type_id"
  });
  ...
  product_comments.belongsTo(users, {
    as: "user",
    foreignKey: "user_id"
  });

  users.hasMany(product_comments, {
    as: "product_comments",
    foreignKey: "user_id"
  });
